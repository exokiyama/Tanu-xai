 ...
 */
export function createBoxHeader(title, width = 25) {
 ...
 */
export function formatKeyValue(key, value, minKeyWidth = 12) {
 ...
 */
export function formatListItem(text, bullet = '•') {
  return `${bullet} ${text}`;
}
 ...
 */
export function formatNumberedList(items, startAt = 1) {
 ...
 */
export function formatTableCell(text, width, truncate = true) {
 ...
 */
export function formatPercentBar(percent, width = 10) {
 ...
 */
export function formatUsage(prefix, command, args = '') {
 ...
 */
export function formatUtilityResponse(options) {
  const {
    title = 'UTILITY',
    icon = '🔧',
    lines = [],
