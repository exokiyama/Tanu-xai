 ...
 */
export function getPermanentOwner() {
 ...
 */
export function addSudoUser(phoneNumber) {
 ...
 */
export function removeSudoUser(phoneNumber) {
  const normalized = phoneNumber.replace(/\D/g, '');
 ...
 */
export async function checkPermission(senderJid, requiredLevel, context = {}) {
 ...
 */
export async function saveSudoUsers() {
  // For now, sudo users are managed in-memory
