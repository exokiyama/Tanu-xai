 ...
 */
export async function loadProtectionConfig() {
  try {
    if (configCache) {
      return configCache;
    }
 ...
 */
export async function getProtection(key) {
 ...
 */
export async function updateProtection(key, value) {
  const config = await loadProtectionConfig();
 ...
 */
export async function isProtectionEnabled(key, context = {}) {
 ...
 */
export function parseProtectionScope(scopeStr) {
 ...
 */
export async function resetProtection(key) {
  const config = await loadProtectionConfig();
