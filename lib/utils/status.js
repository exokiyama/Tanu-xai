 ...
 * @returns {boolean}
 */
async function isStatusMessage(message) {
 ...
 */
async function extractStatusMedia(message) {
 ...
 */
async function saveStatusMedia(buffer, metadata) {
 ...
 */
async function getStatusConfig(userId) {
 ...
 */
async function setStatusConfig(userId, config) {
 ...
 */
async function cleanupOldStatus(maxAgeMs = 48 * 60 * 60 * 1000) {
 ...
 */
function parseStatusAction(arg) {
