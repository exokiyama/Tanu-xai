...
assert.ok(allCommands().length >= 200); assert.doesNotMatch(renderMenu(), /haxtan|dailyreport|botversion|support/); console.log(`registered commands: ${allCommands().length}`);
